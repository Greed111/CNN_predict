...
test_data = my_dataset(mypara.path_data_u_test,
                       ...
                       mypara.path_data_t05_test,
                       mypara.path_data_t25_test,
                       mypara.path_data_t45_test,
                       mypara.path_data_t60_test,
                       mypara.path_data_t90_test,
                       mypara.path_data_t120_test,
                       mypara.test_time)
...
# 优化器
#optimizer = torch.optim.SGD(CNN_9ssh_ssh.parameters(), lr=0.002)
optimizer = torch.optim.Adam(CNN_9ssh_ssh.parameters(), lr=0.001)
...
writer.close()
torch.save(CNN_9ssh_ssh, "sealevel_gpu.pth")
print("模型已保存")