...
train_data = my_dataset(data_u10_test, data_v10_test, data_ssh_test, 552)
test_data = my_dataset(data_u10_train, data_v10_train, data_ssh_train, 120)
...
writer.close()
torch.save(CNN, "sealevel_normlize.pth")
print("模型已保存")